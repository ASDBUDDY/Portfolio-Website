...
function CarouselNew() {
    ...
    <Carousel fade id="scrollspyHeading1" className='bg-dark'>
      <Carousel.Item interval={4000}>
        <video src='https://github.com/ASDBUDDY/asdbuddy.github.io/Portfolio-Website/src/video/Hiddenlens.mp4' className="d-block vw-100 vh-100 min-vw-50 min-vh-50" autoPlay muted loop />
        <Carousel.Caption>
          {CaptionImage()}
        </Carousel.Caption>
      </Carousel.Item>
